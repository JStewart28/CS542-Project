...
echo "all_to_all 1"
mpirun -n 1 all_to_all 0 >> run_Celeste.out
echo "all_to_all 2"
mpirun -n 2 all_to_all 0 >> run_Celeste.out
echo "all_to_all 4"
mpirun -n 4 all_to_all 0 >> run_Celeste.out
echo "all_to_all 6"
mpirun -n 6 all_to_all 0 >> run_Celeste.out
echo "all_to_all 8"
...
echo "count_primes 1"
mpirun -n 1 count_primes 0 >> run_Celeste.out
echo "count_primes 2"
mpirun -n 2 count_primes 0 >> run_Celeste.out
echo "count_primes 4"
mpirun -n 4 count_primes 0 >> run_Celeste.out
echo "count_primes 6"
...
mpirun -n 24 --oversubscribe count_primes 1 >> run_Celeste.out
echo "count_primes 32"
mpirun -n 32 --oversubscribe count_primes 1 >> run_Celeste.out
echo "count_primes 64"
mpirun -n 64 --oversubscribe count_primes 1 >> run_Celeste.out
echo "count_primes 128"
mpirun -n 128 --oversubscribe count_primes 1 >> run_Celeste.out
